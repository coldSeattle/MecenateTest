  ...
  return (
    <YStack>
      <View style={styles.imageContainer}>
        {coverUrl ? (
          <Image source={{ uri: coverUrl }} style={styles.cover} resizeMode="cover" blurRadius={18} />
        ) : (
...
const styles = StyleSheet.create({
  imageContainer: { width: '100%', aspectRatio: 1.6, position: 'relative', overflow: 'hidden' },
  cover: { width: '100%', height: '100%' },
  coverFallback: { backgroundColor: '#1A1A2E' },
  ...
  iconCircle: { width: 52, height: 52, borderRadius: 26, backgroundColor: '#7C3AED', alignItems: 'center', justifyContent: 'center' },
