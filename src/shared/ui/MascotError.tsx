  ...
  return (
    <Animated.View style={[{ width: size, height: size }, animStyle]}>
      <Svg width={size} height={size} viewBox="0 0 120 120">
        ...
        <Path d="M 28 52 Q 14 30 20 14 Q 24 8 28 16 Q 22 32 30 50" fill="url(#gillGrad)" opacity="0.9" />
        <Path d="M 34 48 Q 24 28 30 14 Q 33 8 36 15 Q 28 30 36 46" fill="url(#gillGrad)" />
        <Path d="M 40 46 Q 34 28 38 16 Q 40 10 43 16 Q 38 30 42 44" fill="url(#gillGrad)" opacity="0.85" />
        <Path d="M 92 52 Q 106 30 100 14 Q 96 8 92 16 Q 98 32 90 50" fill="url(#gillGrad)" opacity="0.9" />
        <Path d="M 86 48 Q 96 28 90 14 Q 87 8 84 15 Q 92 30 84 46" fill="url(#gillGrad)" />
        <Path d="M 80 46 Q 86 28 82 16 Q 80 10 77 16 Q 82 30 78 44" fill="url(#gillGrad)" opacity="0.85" />
        ...
        <Ellipse cx="34" cy="100" rx="8" ry="5" fill="#7C3AED" transform="rotate(-25, 34, 100)" />
        <Ellipse cx="27" cy="105" rx="4" ry="3" fill="#9333EA" transform="rotate(-15, 27, 105)" />
        <Ellipse cx="86" cy="100" rx="8" ry="5" fill="#7C3AED" transform="rotate(25, 86, 100)" />
        <Ellipse cx="93" cy="105" rx="4" ry="3" fill="#9333EA" transform="rotate(15, 93, 105)" />
        ...
        <Path d="M 54 82 Q 60 78 66 82" stroke="#6D28D9" strokeWidth="2" strokeLinecap="round" fill="none" />
        <Path d="M 44 74 Q 42 79 44 81 Q 46 79 44 74" fill="#93C5FD" opacity="0.9" />
      </Svg>
    </Animated.View>
  );
});
